...
public class App extends Application {
    ...
    public void start(Stage stage) throws IOException {
        ...
        stage.addEventHandler(KeyEvent.KEY_PRESSED, event -> {
        	...
        	case "1" : g.setCase(0,2, "Touche"); break;
        	case "2" : g.setCase(1,2, "Touche"); break;
        	case "3" : g.setCase(2,2, "Touche"); break;
        	case "4" : g.setCase(0,1, "Touche"); break;
        	case "5" : g.setCase(1,1, "Touche"); break;
        	case "6" : g.setCase(2,1, "Touche"); break;
        	case "7" : g.setCase(0,0, "Touche"); break;
        	case "8" : g.setCase(1,0, "Touche"); break;
        	case "9" : g.setCase(2,0, "Touche"); break;
        	}
        	});
    }
